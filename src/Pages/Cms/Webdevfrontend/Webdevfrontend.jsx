...
import Devfront from "../../../Data/Webdevfront";
import { useNavigate } from "react-router-dom";
import { Box, Button, Typography } from "@mui/material";

const Webdevfrontend = () => {
      ...
      <Box  sx={{margin:"150px 20px"}}>
        {token ? (
          <Box sx={{ backgroundColor: "background.paper" }}>
            <Box className="quiz-container" sx={{ marginTop: "45px",backgroundColor: "background.paper",  boxShadow: "0px 8px 15px rgba(227, 37, 252, 0.7)", textAlign:"center" }}>
              <Typography
                sx={{
                ...
                <Box sx={{ backgroundColor: "background.paper" }}>
                  <div className="result-section">
                    ...
                    <Button
                      onClick={restartQuiz}
                      sx={{ background:
                        "linear-gradient(135deg, #6a11cb, #e325fc)",boxShadow: "0px 8px 15px rgba(227, 37, 252, 0.7)" }}
                    >
                      Restart Quiz
                    </Button>
                  </div>
